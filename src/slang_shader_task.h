...
public:
	...
	[[nodiscard]] godot::Variant get_program_parameter(const godot::StringName& program, const godot::StringName& param) const;
	void set_program_parameter(const godot::StringName& program, const godot::StringName& param, const godot::Variant& value);
	...
	[[nodiscard]] godot::Dictionary get_program_parameters(const godot::StringName& program_name) const;

	godot::TypedArray<godot::RID> get_program_rids(const godot::StringName& program, const godot::StringName& param) const;
	godot::PackedByteArray get_program_buffer_data(const godot::StringName& program, const godot::StringName& param) const;
	godot::Error get_program_buffer_data_async(const godot::StringName& program, const godot::StringName& param, const godot::Callable& callback) const;
...
private:
	...
	godot::HashMap<godot::StringName, ParameterStore> _program_parameters{};
	...
	ProgramData* _get_program_data(const godot::StringName& program_name) const;
