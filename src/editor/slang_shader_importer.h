...
private:
	...
	Ref<ShaderTypeLayoutShape> _get_shape(slang::TypeLayoutReflection* type_layout, int64_t implicit_offset = 0, int64_t slot_offset = 0, bool include_property_info = true) const;
