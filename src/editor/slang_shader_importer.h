...
private:
	...
	Ref<ShaderTypeLayoutShape> _get_shape(slang::TypeLayoutReflection* type_layout, int64_t implicit_offset = 0, int64_t space_offset = 0, bool include_property_info = true) const;
...
private:
	...
	static Error _slang_compile_kernels(slang::IModule* slang_module, TypedArray<ComputeShaderKernel>& out_kernels, const PackedStringArray& additional_entry_points);
