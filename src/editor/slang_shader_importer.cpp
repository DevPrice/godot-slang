...
int32_t SlangShaderImporter::_get_format_version() const {
	...
	// 4: [gd::Material] entry points were compiled into SlangShaderFile (see version 5)
	// 5: materials moved out to SlangMaterialImporter, which imports them as a Shader
	return 5;
}
