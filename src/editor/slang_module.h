...
public:
	...
	godot::Error _compile_kernels(godot::TypedArray<godot::Ref<SlangShaderProgram>>& out_kernels, const godot::Ref<ShaderTypeLayoutShape>& global_params_shape, const godot::PackedStringArray& additional_entry_points = godot::PackedStringArray{});
