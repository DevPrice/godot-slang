...
supported_languages = {
    "en": "Godot Slang %s documentation in English",
}
...
html_context = {
    ...
    "github_user": "DevPrice",  # Username
    "github_repo": "godot-slang",  # Repo name
    "github_version": "main",  # Version
    "conf_py_path": "/",  # Path in the checkout to the docs root
    "godot_docs_title": supported_languages[language],
    "godot_docs_basepath": "https://devprice.github.io/godot-slang/",
